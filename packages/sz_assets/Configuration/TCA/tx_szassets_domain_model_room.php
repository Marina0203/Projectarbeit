...
return [
    ...
    'columns' => [
        ...
        'seat_count' => [
            ...
            'label' => 'LLL:EXT:sz_assets/Resources/Private/Language/locallang_db.xlf:custom_table.seat_count',
            'exclude' => 1,
        ],
        'bookable' => [
            'config' => [
            ...
            'label' => 'LLL:EXT:sz_assets/Resources/Private/Language/locallang_db.xlf:custom_table.bookable',
            'exclude' => 1,
        ],
        't3_origuid' => [
            'config' => [
